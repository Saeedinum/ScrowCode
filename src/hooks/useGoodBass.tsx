...
const useGoodPass = () => {
  ...
  const ProgressBar = <Progress value={score} max={100} className={`absolute right-10 top-[70%] h-[10px] w-[35%] translate-y-[-75%] cursor-text rounded-[1px] bg-transparent ${color}`} />
