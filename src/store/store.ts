...
export const store = configureStore({
  ...
  middleware: getDefaultMiddleware =>
    getDefaultMiddleware().concat(authAPI.middleware, findTeamAPI.middleware, profileAPI.middleware, ordersAPI.middleware, findPartnerAPI.middleware, createTeamAPI.middleware)
})
