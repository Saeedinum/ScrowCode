    ...
    <>
      <main dir="rtl" className="flex max-w-full flex-col">
        <section className="relative flex items-center justify-center overflow-x-clip">
          <img src={backgroundleft} alt="background image" className="absolute left-0 top-0 z-0 max-lg:w-[40%] lg:-top-24" />
          <img src={backgroundright} alt="background image" className="absolute right-0 top-0 z-0 max-lg:w-[40%] lg:-top-24" />
        ...
        <section ref={startSection} className="relative mt-20 flex flex-col items-center justify-center sm:gap-20">
          ...
          <section dir="ltr" className="relative flex w-full flex-col md:flex-row md:items-center md:gap-14">
            <img src={star1} alt="" className="absolute left-1/2 top-0 z-30 hidden lg:block" />
