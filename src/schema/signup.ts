...
import { name, behanceRegex, email, githubRegex, linkedinRegex, password, phone, username, universityEmailRegex } from "./regex"
...
export const personalInformationSchema = z
  .object({
    ...
    username: z.string().min(1, { message: "username is required" }).regex(username, { message: "Please enter a valid username" }),
