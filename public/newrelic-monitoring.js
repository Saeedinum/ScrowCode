...
(function () {
  ...
  NREUM.loader_config = {
    accountID: import.meta.env.REACT_APP_NEW_RELIC_ACCOUNT_ID,
    trustKey: import.meta.env.REACT_APP_NEW_RELIC_TRUST_KEY,
    agentID: import.meta.env.REACT_APP_NEW_RELIC_AGENT_ID,
    licenseKey: import.meta.env.REACT_APP_NEW_RELIC_LICENSE_KEY,
    applicationID: import.meta.env.REACT_APP_NEW_RELIC_APPLICATION_ID,
  };

  NREUM.info = {
    beacon: import.meta.env.REACT_APP_NEW_RELIC_BEACON,
    errorBeacon: import.meta.env.REACT_APP_NEW_RELIC_ERROR_BEACON,
    licenseKey: import.meta.env.REACT_APP_NEW_RELIC_LICENSE_KEY,
    applicationID: import.meta.env.REACT_APP_NEW_RELIC_APPLICATION_ID,
    sa: 1,
  };
  ...
  (i.m = r),
    ...
    (i.l = (r, n, o, a) => {
      if (e[r]) e[r].push(n);
        ...
        if (!s) {
          c = !0;
          var f = {
            478: "sha512-bjdCR8n9LQBegnlzuzuIEHsaT9AodeqLLuPeO694mIy66nuuLVs4YfdocwMLwg01cJXbQCvR/SUEO6bZapVERA==",
            249: "sha512-HkzmyWwSGuSChOkFt8Y9uj6eNtWyYiRe7xyMhV28/Nt68/HUwqj8bQJ04hX6XaDUmcuBqX2bOPBoISyzfTJJdw==",
            212: "sha512-XdMlZDJzTn+0V9I0WYb3+v/0Uu051H0U8UI0EA3Xj4a3rQHkZYIxc6Fj5zDmenNMmH9huns5X1dpyfboksWiGw==",
          };
    ...
    (() => {
      ...
      var t = (t, r) => {
        ...
        r = (self["webpackChunk:NRBA-1.268.0.PROD"] =
          self["webpackChunk:NRBA-1.268.0.PROD"] || []);
